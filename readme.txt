...
3. You will be presented with a menu that will let you choose to visualize the structure of the entire file, or just parts of the file that match the criteria you give it. 
...
5. Graphviz will update the visualization as you choose different menu options and the stylesheet can be edited and the program will refresh it on the next visualization without having to restart.
